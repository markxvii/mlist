...
def register_commands(app):
    ...
    def init(locale):
        ...
        if os.system(
                'pybabel init -i messages.pot -d mlist/translations -l' + locale):
    ...
    def update():
        ...
        if os.system('pybabel extract -F babel.cfg -k _l -o messages.pot .'):
            raise RuntimeError('extract command failed')
        if os.system('pybabel update -i messages.pot -d mlist/translations'):
    ...
    def compile():
        ...
        if os.system('pybabel compile -d mlist/translations'):
